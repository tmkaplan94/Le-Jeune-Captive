...
label palaisb_run_left:
    ...
    unkown "Stop right there!"

    Jean "Oh, Baise moi."

    #show Security Guard

    Security Guard "Oh, Minister Valjean! Were you the one running around?"

    Jean "Yes, it was me.  I am in a bit of a hurry, so if you’ll excuse m--"

    Security Guard "Ah, I see.  I didn’t mean to startle you, sir, but we’re on high alert. Representative Touti came by earlier and notified security about a suspicious individual lurking around the South Wing..."
    ...
    Security Guard "Alright then, just… be careful, Minister. Wouldn’t want anything to happen to you when nobody’s around."
...
label palaisb_run_right:
    ...
    unknown "Hey, hold it right there!"
...
label palaisb_hide:
    ...
    unknown "C'est quoi ce bordel? Is that you, Jean? The hell are you doing, mon ami? Watering the ficus?"
...
label palaisb_tax:
    ...
    Minister Bergier,
        ...
        We are displeased with the proposal of higher income tax rates on the upper brackets. We understand that the bill has immense popular support, and will not demand its outright repeal. Be that as it may, the bill as it stands now is unacceptable for many of our councillors. We ask that you cooperate with us to introduce a set of amendments to the bill to allow for tax write-offs equivalent to the increase in taxation. We will send the specific instructions in a separate missive.
...
label palaisb_military:
    ...
    Minister Bergier,
        ...
        Many councillors are invested in enterprises related to the production of military armaments. Ensure that there will be a substantial increase in the military budget, at minimum a 20% from last year. Rest assured we have no interest in antagonizing other nations with our armed forces.
...
label palaisb_election:
    ...
    Concerns have emerged over the current election projections in the Seine Department. We are confident in our ability to retain our political hold over the department, but there are too many liabilities with the current selection of political candidates. We ask that you use your influence to secure our victory. Attached is a list of candidates we desire to hold office. Memorize it and destroy the evidence.
